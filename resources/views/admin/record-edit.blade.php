                                        ...
                                        <form action="{{ route('record.update', $event->id) }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="status" id="status"
                                                    onchange="habilitar();"
                                                    value="{{ old('title', $event->status) }}">
                                                    <option
                                                        {{ $event->status == 'Trabajo' ? 'selected="selected"' : '' }}>
                                                        Trabajo</option>
                                                    <option
                                                        {{ $event->status == 'Descanso' ? 'selected="selected"' : '' }}>
                                                        Descanso</option>
                                                </select>
                                            </div>
                                            <hr>
